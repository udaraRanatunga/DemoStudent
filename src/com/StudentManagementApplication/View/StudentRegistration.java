...
public class StudentRegistration extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        {
            flag=1;
            JOptionPane.showMessageDialog(jTextField1,"Please fill in the Student Name", "Warning", JOptionPane.WARNING_MESSAGE);
        }
        if (jTextField2.getText().equals(""))
        {
            flag=1;
            JOptionPane.showMessageDialog(jTextField2,"Please fill in the Student Address", "Warning", JOptionPane.WARNING_MESSAGE);
        }
        if (jTextField3.getText().equals(""))
        {
            flag=1;          
            JOptionPane.showMessageDialog(jTextField3,"Please fill in the Grade", "Warning", JOptionPane.WARNING_MESSAGE);
        ...
        if (flag==0)
        {
            ...
            student.setAddress(jTextField2.getText());
            student.setGrade(jTextField3.getText());
            int rs =dbs.insert(student);
            if (rs==1)
            {
